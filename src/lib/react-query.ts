import { UseQueryOptions, UseMutationOptions, DefaultOptions } from '@tanstack/react-query';
...
export type QueryConfig<QueryFnType extends (...args: any) => Promise<any>> = Omit<
  UseQueryOptions<ApiFnReturnType<QueryFnType>>,
  'queryKey' | 'queryFn'
>;
